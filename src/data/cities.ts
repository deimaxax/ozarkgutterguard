...
export const CITIES_DATA: Record<string, CityData> = {
  "bentonville": {
    ...
    title: "Bentonville Gutter Guards | Ozark Gutter Guard Co.",
    ...
    h1: "Permanent Gutter Protection in Bentonville, AR",
  ...
  "bella-vista": {
    ...
    title: "Bella Vista Gutter Guards & Pine Needle Mesh",
    ...
    h1: "Micro-Mesh Gutter Protection Built for Bella Vista Pines",
  ...
  "rogers": {
    ...
    cityName: "Rogers",
    cityState: "Rogers, AR",
    title: "Rogers AR Gutter Guard Installation & Repair",
    ...
    h1: "Commercial-Grade Gutter Guards in Rogers, AR",
  ...
  "fayetteville": {
    ...
    title: "Fayetteville Gutter Guards | Local NWA Installers",
    ...
    h1: "Heavy-Duty Gutter Protection in Fayetteville, AR",
  ...
  "springdale": {
    ...
    title: "Springdale Gutter Guards & Foundation Protection",
    ...
    h1: "Reliable Gutter Shield Installation in Springdale",
