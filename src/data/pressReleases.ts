...
export const PRESS_RELEASES_DATA: PressRelease[] = [
  {
    ...
    bodyParagraphs: [
      ...
      "The satellite technology pairs with Ozark Gutter Guard's direct-to-consumer 316 surgical marine-grade stainless steel micro-mesh. The 50-micron filtration system is engineered specifically for Northwest Arkansas's 47.5 inches of annual rainfall and heavy spring oak catkin drops, backed by a transferable 10-Year No-Clog Guarantee."
    ],
    mediaContact: {
    ...
    aboutCompany: "Ozark Gutter Guard Co. is a licensed and insured Northwest Arkansas exterior drainage contractor specializing in 316 surgical stainless steel micro-mesh gutter protection, seamless gutter fabrication, and roofline drainage audits. Headquartered in Bentonville, Arkansas, the company serves residential and commercial properties throughout Benton and Washington Counties."
  },
  {
    id: "pr-2026-02",
  ...
  },
  {
    ...
    headline: "Engineered specifically for steep 10/12 to 12/12 hillside rooflines, new surgical micro-mesh prevents hazardous ladder falls and protects bluff-side retaining walls.",
    metaTitle: "Bella Vista Pine Needle Gutter Protection Program Expanded | Ozark Gutter Guard",
    metaDescription: "Bella Vista AR — 50-micron surgical micro-mesh gutter protection expanded across Bella Vista Highlands, Lake Loch Lomond, and Scotsdale communities for permanent pine needle defense.",
