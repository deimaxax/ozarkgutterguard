...
export const LOCAL_CASE_STUDIES: Record<string, LocalCaseStudy[]> = {
  "bentonville": [
    ...
    },
    {
      ...
      solutionExecuted: "Stripped failed plastic covers, power-flushed 6 downspout drops, installed heavy-duty high-flow inside valley splash diverters, reinforced rafter brackets at 24-inch intervals, and mounted continuous 316 surgical mesh flush to aluminum fascia lip.",
      materialUsed: "316 Surgical Stainless Micro-Mesh + Heavy Gauge Valley Shield Assemblies",
    ...
    },
    {
      ...
      solutionExecuted: "Upgraded 26 failing brackets to 1.5\" structural zinc screw hidden hangers, laser-re-pitched 3 runs toward commercial 3x4 drop outlets, and installed 50-micron surgical mesh with polyurethane joint welds.",
      materialUsed: "316 Surgical Marine-Grade Mesh + Heavy-Duty Hidden Hangers",
  ...
  "bella-vista": [
    {
      ...
      solutionExecuted: "Removed clogged vinyl guards, vacuum-extracted 4.5 cubic feet of compacted pine sludge, installed 50-micron 316 surgical stainless mesh flush to front lip and fascia, laser-aligned pitch, and re-anchored rear eaves with heavy zinc screw hangers.",
      materialUsed: "316 Surgical Stainless 50-Micron Micro-Mesh + Heavy Anodized Aluminum Base",
    ...
    },
    {
      ...
      solutionExecuted: "Full rotten wood extraction, installation of rot-proof composite fascia backer, laser slope tuning, sealed 6 corner miters with thermoplastic polyurethane, and precision installation of surgical micro-mesh with steep-pitch valley diverters.",
  ...
  "rogers": [
    {
      ...
      materialUsed: "316 Marine-Grade Surgical Stainless Steel + T6 Heavy Aluminum Extrusion",
    ...
    },
    {
      ...
      solutionExecuted: "Removed reverse-curve hoods, replaced 34 failing aluminum clips with 1.5\" structural zinc screw hidden hangers, realigned slope, and mounted 316 surgical micro-mesh directly to gutter lip and fascia.",
      materialUsed: "316 Surgical Stainless Mesh with 50-Micron Weave",
      intakeRateTested: "150 in/hr throughput verified",
      completedDate: "April 2026",
  ...
  "fayetteville": [
    {
      ...
      solutionExecuted: "Extracted 3.8 cubic feet of wet leaf compost, laser-leveled 5 sagging trough sections, added 2 high-capacity downspout extenders redirecting runoff 12 feet from foundation footing, and secured 316 surgical mesh with zinc screw brackets.",
      materialUsed: "316 Heavy Stainless Surgical Mesh + Anodized Aluminum Chassis",
    ...
    },
    {
      ...
      solutionExecuted: "Replaced damaged fascia with matching primed rot-proof composite trim, realigned trough slope with laser level, sealed box miters, and installed low-profile 50-micron surgical mesh attached exclusively to fascia and gutter lip.",
      materialUsed: "Low-Profile 316 Surgical Stainless Mesh with Charcoal Anodized Aluminum Frame",
  ...
  "springdale": [
    {
      ...
      solutionExecuted: "Laser re-pitched 4 trough runs to eliminate standing water pockets, installed 50-micron 316 surgical micro-mesh, connected 3 underground downspout extension adaptors discharging 10 feet from foundation footing.",
      materialUsed: "316 Surgical Micro-Mesh + High-Capacity Downspout Transition Boots",
  ...
  "centerton": [
    {
      ...
      solutionExecuted: "Installed 50-micron 316 surgical micro-mesh with extruded aluminum chassis across all 210 LF. Upgraded 2 downspouts to 3x4 inch commercial high-capacity drop outlets, laser-realigned slope on 2 sagging rear sections.",
      materialUsed: "316 Surgical Stainless Micro-Mesh + Commercial 3x4 Drop Outlets",
  ...
  "cave-springs": [
    {
      ...
      solutionExecuted: "Complete gutter tune-up, laser pitch correction on 6 trough runs, sealed all miters with high-grade polyurethane, and installed 50-micron surgical steel micro-mesh with custom valley splash diverters.",
  ...
  "lowell": [
    {
      ...
      materialUsed: "316 Surgical Stainless Micro-Mesh + Hidden Heavy-Duty Zinc Brackets",
      intakeRateTested: "150 in/hr verified",
      completedDate: "March 2026",
