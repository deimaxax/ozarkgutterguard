...
const post: GuidePost = {
  ...
  metaDescription:
    'Bella Vista\'s Loblolly and Shortleaf pines shed needles year-round. Why they destroy standard guards, what happens to fascia boards, and the only filtration that stops them.',
  category: 'trees',
  readTime: '8 min read',
  ...
  intro:
    'Bella Vista, Arkansas has one of the most beautiful natural environments in the Midwest — and one of the most relentless gutter maintenance problems in Northwest Arkansas. The culprit is the same thing that makes Bella Vista beautiful: its dense Loblolly and Shortleaf pine forest canopy.',
...
**Slotted vinyl guards (5–8mm slots):** Pine needles enter the slot vertically, tip-first. Once the tip enters, the slight curve of the needle locks it in place. Needles accumulate faster than they can blow out, building a "needle bridge" across the slot opening.
...
Homeowners on Lake Loch Lomond and Highlands Boulevard frequently discover fascia board rot during exterior painting projects — a repair costing $350–$900 per run that is almost entirely preventable.`,
    },
    {
