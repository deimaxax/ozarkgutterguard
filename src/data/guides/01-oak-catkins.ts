...
const post: GuidePost = {
  ...
  metaDescription:
    'Post Oak and White Oak catkin season hits Bentonville, Rogers & Fayetteville every April. Why tassels turn into concrete sludge — and the only filter that stops them.',
  category: 'trees',
  readTime: '5 min read',
  ...
  intro:
    'Every April in Northwest Arkansas, homeowners in Bentonville, Rogers, and Fayetteville face the same emergency: gutters that were clear in March are completely sealed by April 15th. The culprit is something most people have never heard of — oak catkins.',
...
**Reverse-curve "leaf helmet" hoods (LeafGuard, etc.):** Catkins catch in the curved intake slot and build up along the nose until the slot is sealed. Water then overshoots the hood entirely.
...
The window to prevent this is before April 1st. A full pre-catkin cleanout and micro-mesh installation before peak drop means catkins never enter the system at all.`,
  ...
  relatedSlugs: [
    'oak-tassel-gutter-protection',
    'gutter-cleaning-bentonville-ar',
    'spring-gutter-cleaning-bentonville-ar',
  ],
};
