...
const post: GuidePost = {
  ...
  metaDescription:
    'Foundation cracks in Bentonville, AR are almost always caused by Vertisol clay soil expanding from roof water overflow. Here\'s the diagnosis and permanent fix.',
  category: 'foundation',
  readTime: '7 min read',
  ...
  intro:
    'If you\'re seeing hairline cracks in your Bentonville, Rogers, or Springdale drywall — or diagonal cracks spreading from door corners — there is an 80% chance the cause is right above you on your roof. Not inside your walls.',
...
**4. Gutter sag** — Look along gutter runs from the corner of your yard. Any section dipping below the others is collecting standing water that eventually overflows.`,
    },
    {
      heading: 'The Math: One Clogged Gutter = 750 Gallons Against Your Foundation Per Storm',
      body: `A standard Bentonville ranch home with a 1,800 sq ft roof generates approximately 1,125 gallons of water during a 1-inch rain event (roof sq ft × rainfall inches × 0.623). In Northwest Arkansas, 1-inch events happen 8–12 times per spring season.
...
These two changes, typically completed in a single afternoon for $1,250–$1,850, eliminate the water source causing your foundation movement. They do not repair existing cracks — that requires a structural engineer — but they stop the progression and prevent new damage.`,
    },
  ],
