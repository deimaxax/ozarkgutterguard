...
const post: GuidePost = {
  ...
  metaDescription:
    'Northwest Arkansas receives 47.5 inches of rain per year with flash events exceeding 2 in/hr. Why standard 5-inch gutters and cheap guards fail — and what the data says.',
  category: 'weather',
  readTime: '6 min read',
...
A standard 5-inch residential gutter can theoretically handle approximately 2.5 inches of rain per hour under ideal conditions. In real-world conditions — with any debris, any slope degradation, any clog — that capacity drops to 1.5–2 inches/hour.
...
The 150 in/hr rating provides a 60× safety margin over the worst storm ever recorded in Northwest Arkansas. The surgical mesh's hydrodynamic capillary design means water is actively pulled through via surface tension, rather than relying on gravity alone. This is why debris on the surface doesn't immediately cause overflow — water routes around debris and continues entering the trough.`,
    },
    {
      ...
      body: `The highest-intensity rainfall events in NWA occur during tornado season (March–May) and tropical remnant season (September–October). These windows coincide exactly with:
