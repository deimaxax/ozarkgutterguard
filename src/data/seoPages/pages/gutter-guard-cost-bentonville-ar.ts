...
export const page: SeoPageData = {
  ...
  "subheadline": "LeafFilter quotes $5,500–$7,200 for standard Bentonville homes. Ozark Gutter Guard installs identical 316 marine-grade 316 micro-mesh for $1,250–$1,850. Here's the exact breakdown.",
  "painPointTitle": "Understanding Gutter Guard Pricing in the Bentonville Market",
  "painPoints": [
    {
      "title": "Single-Story Bentonville Ranch (120–150 LF): $1,050–$1,350",
      "description": "Complete turnkey: full cleanout, laser slope realignment, 50-micron 316 stainless mesh, 1.5\" zinc hanger reinforcement, corner miter sealing. ZIP 72712, 72713, 72716."
    },
    {
      "title": "Two-Story Bentonville Home (160–220 LF): $1,350–$1,750",
      "description": "Includes specialized two-story rigging, downspout extenders, valley splash diverters, and our full 10-Year Transferable Written Guarantee."
    },
    {
      "title": "Large Estate / New Construction (220–300 LF): $1,750–$2,350",
      "description": "Full perimeter armor for sprawling rooflines near I-49 corridor and Centerton border subdivisions. Can be bundled with new seamless gutter installation."
    }
  ],
  "localContext": {
    "heading": "Bentonville Gutter Guard Pricing: What You Actually Pay vs What Franchises Quote",
    "content": "In the Bentonville, AR market (ZIP codes 72712, 72713, 72716), LeafFilter franchise quotes for a standard 180 linear foot two-story home run $5,500–$7,200. The same installation from Ozark Gutter Guard — with identical 316 marine-grade 316 stainless micro-mesh specification and a 10-Year Transferable Written Guarantee — costs $1,450–$1,750. The $3,500–$5,000 price difference funds LeafFilter's national television advertising budget, commissioned in-home sales rep wages, and franchise corporate royalties. We eliminate all three. Our satellite quote system measures your exact Bentonville property using GIS aerial imagery and delivers a guaranteed fixed price via SMS in 15 minutes. No in-home appointment. No pressure. No expiring discounts. Call (479) 929-2516 or request a quote online."
  },
  "geoCoordinates": {
    "latitude": 36.3729,
    "longitude": -94.2088
