...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "How to Stop Pine Needles in Gutters: Aperture Physics",
      "description": "Loblolly pine needle tips are 1,000–2,000 microns in diameter. Standard slotted vinyl (5,000 microns) and national mesh (250 microns) act as combs. 50-micron mesh blocks them completely."
    },
    {
      "title": "Steep Hillside Eave Drop Safety in Bella Vista",
      "description": "Bella Vista walkout rear eaves reach 25–30 feet on Loch Lomond and Highlands slopes. 50-micron pine armor eliminates dangerous ladder climbing permanently."
    },
    {
      "title": "Acidic Pine Tannin Corrosion Defense",
      "description": "Decomposing pine needles release tannic acid (pH 3.5–4.5). Our 316 marine-grade stainless steel and anodized aluminum frame resist pine tannin acid for 20+ years."
    }
  ],
  "localContext": {
