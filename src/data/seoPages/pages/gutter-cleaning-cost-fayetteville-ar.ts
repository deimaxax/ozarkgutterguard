...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Mount Sequoyah Steep Pitch Premium: $175–$250",
      "description": "Hillside homes above 8/12 pitch require specialized ladder standoffs and safety rigging — responsible contractors charge a 20–30% premium for high-hazard eave access."
    },
    {
      "title": "Wilson Park Historic District: $150–$200",
      "description": "Historic district homes require careful ladder placement to protect original wood fascia trim — standard rush-job cleaners can scratch or damage irreplaceable architectural details."
    },
    {
      "title": "University District Oak Volume = 4 Required Visits/Year",
      "description": "Homes under centennial Sugar Maple and heritage oak canopy near the UA campus need spring catkin cleanouts, mid-summer check, fall leaf removal, and post-freeze inspection."
    }
  ],
  "localContext": {
