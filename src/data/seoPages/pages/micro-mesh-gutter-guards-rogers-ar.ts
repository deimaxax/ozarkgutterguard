...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Beaver Lake Humidity Requires 316 Marine Steel",
      "description": "Standard 304 stainless micro-mesh corrodes under sustained Beaver Lake microclimate humidity. Only 316 marine-grade alloy provides lifetime corrosion resistance."
    },
    {
      "title": "50-Micron Blocks Maple Helicopter Seeds",
      "description": "Silver Maple helicopter seeds are thin enough to penetrate national brand 150+ micron mesh. Our 50-micron weave blocks 100% of helicopter seed tips."
    },
    {
      "title": "150 in/hr Capacity for Prairie Creek Flash Storms",
      "description": "Rogers' Prairie Creek watershed concentrates storm runoff rapidly. Standard plastic-frame micro-mesh deflects in flash storm conditions our steel frame handles easily."
    }
  ],
  "localContext": {
