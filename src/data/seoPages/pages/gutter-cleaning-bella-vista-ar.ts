...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Year-Round Pine Needle Shedding",
      "description": "Unlike deciduous trees, Bella Vista's Loblolly and Shortleaf pines shed needles continuously through all four seasons â€” there is no \"clean season\" without permanent protection."
    },
    {
      "title": "Needle Mat Weight on Steep Pitches",
      "description": "Wet pine needle mats on 9/12â€“12/12 pitches can weigh 30â€“40 lbs per section, bending aluminum gutter lips and pulling hangers from steep fascia boards."
    },
    {
      "title": "25â€“30 Foot Drop-Offs at Rear Eaves",
      "description": "Hillside home rear eaves in Loch Lomond and Highlands are dangerously high. DIY ladder cleaning is the leading cause of homeowner ER visits in Benton County."
    }
  ],
  "localContext": {
