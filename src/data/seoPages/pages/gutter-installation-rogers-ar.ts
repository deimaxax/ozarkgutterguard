...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Pinnacle Hills Multi-Story Runoff",
      "description": "Two and three-story luxury estates in Pinnacle Hills (72758) concentrate enormous water volumes that standard 5-inch builder gutters cannot manage."
    },
    {
    ...
    },
    {
      ...
      "description": "Silver Maple helicopter seeds and mature oak debris from Prairie Creek fill gutters within 48 hours during peak April storms."
    }
  ],
  "localContext": {
