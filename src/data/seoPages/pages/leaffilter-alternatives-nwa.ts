...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "LeafFilter Cost Per Foot NWA: $35–$45/ft vs $8.50–$10.50/ft",
      "description": "LeafFilter quotes for standard 180 LF homes in Bentonville, Rogers, and Fayetteville average $5,500–$7,200. Ozark Gutter Guard installs identical 316 stainless specification for $1,350–$1,750."
    },
    {
      "title": "Frame Metallurgy: Extruded T6 Aluminum vs uPVC Plastic",
      "description": "LeafFilter glues steel mesh over uPVC plastic frames that can warp under 100°F+ Ozark summer heat. We use rigid extruded T6 aluminum chassis that never warps or sags."
    },
    {
      "title": "Zero Shingle Contact vs Under-Shingle Warranty Hazards",
      "description": "Our 50-micron mesh mounts strictly to the gutter lip and fascia board, preserving 100% of your GAF, CertainTeed, or Owens Corning roof warranty."
    }
  ],
  "localContext": {
