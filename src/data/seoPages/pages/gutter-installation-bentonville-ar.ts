...
export const page: SeoPageData = {
  ...
  "painPoints": [
    ...
    },
    {
      ...
      "description": "Post Oak and White Oak catkin drop hits Downtown and Coler Mountain neighborhoods relentlessly from March through May â€” new gutters need micro-mesh from day one."
    }
  ],
  "localContext": {
