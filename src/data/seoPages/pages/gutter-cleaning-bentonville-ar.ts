...
export const page: SeoPageData = {
  ...
  "painPoints": [
    ...
    },
    {
      ...
      "description": "Spiky sweetgum balls jam downspout elbows at the first 90Â° bend, backing up 1,200+ gallons per storm event with nowhere to drain except your foundation."
    }
  ],
  "localContext": {
