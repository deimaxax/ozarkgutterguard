...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Mount Sequoyah Extreme Slopes",
      "description": "Steep 10/12-12/12 pitches along Mount Sequoyah and Kessler Mountain accelerate runoff velocity past anything standard 5-inch gutters can capture."
    },
    {
      "title": "Historic Preservation Requirements",
      "description": "Wilson Park and Washington-Willow historic district homes require fascia-only mounting that preserves wood trim integrity and architectural character."
    },
    {
      "title": "University District Heavy Canopy",
      "description": "Centennial Sugar Maples and heritage oaks near the UA campus produce the heaviest single-event leaf drops in all of Washington County."
    }
  ],
  "localContext": {
