...
export const page: SeoPageData = {
  "slug": "gutter-guards-prairie-creek-rogers-ar",
  "cluster": "location",
  "city": "Rogers",
  "metaTitle": "Prairie Creek Gutter Guards | Beaver Lake Waterfront Mesh Rogers AR",
  ...
  "painPoints": [
    {
      "title": "Beaver Lake Humidity & Accelerated Rot",
      "description": "High lake humidity stops wet leaf sludge from drying, accelerating fascia wood decay and mold behind aluminum troughs."
    },
    {
      "title": "Dense Shortleaf Pine & Hardwood Canopy",
      "description": "Oily pine needles and red oak leaves pack into open gutters, creating heavy dams that detach loose nail spikes."
    },
    {
      "title": "Steep Hillside Lot Washout",
      "description": "Rainwater spilling over clogged gutters washes away steep lake-lot topsoil, terraces, and expensive retaining walls."
    }
  ],
  "localContext": {
