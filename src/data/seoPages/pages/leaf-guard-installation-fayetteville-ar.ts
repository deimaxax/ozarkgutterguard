...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Old-Growth Tree Mass Debris Events",
      "description": "Fayetteville's 70-year-old oaks and heritage maples produce single-storm debris events that collapse cheap plastic guards under wet leaf weight."
    },
    {
    ...
    },
    {
      ...
      "description": "Clogged gutters on Kessler Mountain and Mount Sequoyah slopes dump water directly against hillside foundation walls, flooding crawlspaces."
    }
  ],
  "localContext": {
