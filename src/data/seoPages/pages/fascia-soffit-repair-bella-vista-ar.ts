...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Acidic Pine Needle Moisture Traps",
      "description": "Decomposing Loblolly pine needles release acidic moisture against wooden fascia boards, rotting structural wood under gutter hangers in 2–3 seasons."
    },
    {
      "title": "Dangerous 25-Foot Hillside Access",
      "description": "Bella Vista steep hillside foundations create extreme eave heights. Our technicians use specialized ridge standoffs and safety harnesses to replace fascia safely."
    },
    {
