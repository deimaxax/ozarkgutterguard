...
export const page: SeoPageData = {
  "slug": "gutter-guards-metfield-bella-vista-ar",
  "cluster": "location",
  "city": "Bella Vista",
  ...
  "painPointTitle": "Metfield Golf Community Foliage & Eave Risks",
  "painPoints": [
    {
      "title": "Dense Shortleaf Pine & Oak Mix",
      "description": "Metfield properties sit under mixed pine-hardwood canopies that drop debris 12 months out of the year."
    },
    {
      "title": "Rotting Wooden Fascia & Soffits",
      "description": "Water trapped inside pine-choked gutters seeps into fascia trim, rotting structural rafter tails."
    },
    {
      "title": "Dangerous Ladder Heights on Sloped Lots",
      "description": "Uneven hillside grounds make ladder positioning hazardous for older homeowners attempting DIY cleanouts."
    }
  ],
  "localContext": {
