...
export const page: SeoPageData = {
  ...
  "painPoints": [
    ...
    },
    {
      ...
      "description": "Single-story ranches (120–150 LF): $1,050–$1,350 total. Two-story homes (180–220 LF): $1,350–$1,750 total. Large multi-level estates (250+ LF): $1,850–$2,350 total."
    },
    {
      "title": "Hidden Franchise Add-On Surcharges",
      "description": "National brands charge $500–$1,000 extra for gutter cleanout, slope realignment, and miter sealing. We include all 3 in our base contractor price."
    }
  ],
  "localContext": {
