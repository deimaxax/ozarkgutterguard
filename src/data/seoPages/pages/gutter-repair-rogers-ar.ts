...
export const page: SeoPageData = {
  ...
  "painPoints": [
    ...
    },
    {
      ...
      "description": "Sagging pitch on two-story Shadow Valley homes causes water to pool in low sections and cascade over gutter lips against landscaping and foundations."
    },
    {
      "title": "Downspout Disconnection from Elbow Joints",
      "description": "Mature silver maple helicopters jam elbow joints at downspout transitions, building pressure that pushes elbows apart over time."
    }
  ],
  "localContext": {
