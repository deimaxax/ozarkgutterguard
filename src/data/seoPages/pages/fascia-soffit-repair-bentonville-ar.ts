...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Water Seeps Behind Gutter Lip",
      "description": "When Bentonville gutters sag or overflow, water runs behind the gutter lip and soaks the fascia board continuously, rotting structural wood in as little as 2 seasons."
    },
    {
      "title": "Rot Spreads Into Rafter Tails",
      "description": "Fascia rot in Bentonville's humid summers spreads into rafter tail framing, turning a $400 board replacement into a $2,000+ structural repair if caught late."
    },
    {
