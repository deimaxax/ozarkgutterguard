...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Builder Gutters Undersized for Large Rooflines",
      "description": "Sprawling Springdale homes with 200–300 LF of roof perimeter routinely come with undersized 5-inch builder gutters that overflow during the first heavy spring storm."
    },
    {
      "title": "Clay Soil Foundation Risk from Day One",
      "description": "New Springdale construction without proper gutter capacity allows Vertisol clay soil saturation from the first rainy season, cracking slabs before the home is 2 years old."
    },
    {
      "title": "Agricultural Pollen Requires 50-Micron Protection",
      "description": "Springdale's unique agricultural dust environment demands micro-mesh from installation day — standard open gutters fill with pollen-dust cement within one season."
    }
  ],
  "localContext": {
