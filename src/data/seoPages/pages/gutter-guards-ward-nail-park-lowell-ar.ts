...
export const page: SeoPageData = {
  "slug": "gutter-guards-ward-nail-park-lowell-ar",
  "cluster": "location",
  "city": "Lowell",
  ...
  "painPointTitle": "Lowell Residential Canopy & Gutter Slope Failures",
  "painPoints": [
    {
      "title": "Oak Catkin & Hickory Nut Sludge",
      "description": "Dense spring oak catkins and heavy fall hickory debris form concrete-like sludge packs inside 5-inch troughs."
    },
    {
      "title": "Sub-Fascia Board Water Decay",
      "description": "Water backing up behind clogged gutter channels rots wooden rafter tails and causes costly soffit repairs."
    },
    {
      "title": "Standing Water Mosquito Breeding",
      "description": "Sagging gutters retain stagnant water pockets that become mosquito breeding grounds near back patios."
    }
  ],
  "localContext": {
