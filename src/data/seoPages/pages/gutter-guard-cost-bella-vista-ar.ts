...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Steep Pitch Premium ($200–$400 Added)",
      "description": "Rooflines above 9/12 pitch require specialized ladder standoffs and safety rigging, adding $200–$400 to total cost — but eliminating dangerous DIY ladder attempts permanently."
    },
    {
      "title": "Hillside Standard Ranch (120–160 LF): $1,150–$1,550",
      "description": "Lake Loch Lomond and Highlands standard single-story ranch homes with pine needle-specific 50-micron filtration. Includes fascia moisture audit."
    },
    {
      "title": "Steep Two-Story Ridgeline (170–230 LF): $1,600–$2,100",
      "description": "Scotsdale and Highland Ridge elevated homes with 10/12+ pitches, specialized rigging, valley splash guards, and full 10-Year Guarantee."
    }
  ],
  "localContext": {
