...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "March–May Post Oak Catkin Avalanche",
      "description": "Downtown and Coler Mountain homeowners see gutters completely sealed by dense catkin mats within 3 days of peak tassel drop — before the heaviest spring storms arrive."
    },
    {
      "title": "Sludge Hardens Into Concrete Blocks",
      "description": "Wet catkins mixed with clay roof grit dry into rock-hard concrete cylinders inside downspout elbows, requiring mechanical snaking rather than simple flushing."
    },
    {
      "title": "Spring Storm Season Starts Before Cleanout Season",
      "description": "NWA's heaviest spring rains (April) arrive weeks before most homeowners think to schedule cleaning — causing foundation flooding before the problem is visible."
    }
  ],
  "localContext": {
