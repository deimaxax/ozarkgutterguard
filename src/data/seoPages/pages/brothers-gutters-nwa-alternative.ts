...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Same Technology — No Franchise Royalty Markup",
      "description": "Brothers franchisees pay 6–8% monthly royalties to corporate HQ. That cost flows directly into your quote. We are locally owned with zero franchise fees."
    },
    {
      "title": "Local NWA Crew vs National Dispatch Model",
      "description": "When you call Brothers, you reach a national dispatch center. When you call Ozark Gutter Guard, you reach the local Benton County technician who will show up at your door."
    },
    {
      "title": "15-Minute Satellite Quote vs In-Home Sales Appointment",
      "description": "No scheduling a 3-hour in-home presentation window. We use GIS satellite aerial imagery to quote your exact property in 15 minutes via SMS."
    }
  ],
  "localContext": {
