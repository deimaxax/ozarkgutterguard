...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Steep Pitch Requires Precision Slope Engineering",
      "description": "On 9/12–12/12 Bella Vista pitches, gutter slope must be precisely engineered — too shallow causes standing water, too steep causes water to outrun downspout capacity."
    },
    {
      "title": "Hillside Rear Eaves Require Specialized Rigging",
      "description": "Bella Vista rear eave drops of 25–30 feet require ladder standoff systems unavailable to standard contractors — improper rigging causes gutter lip damage during installation."
    },
    {
      "title": "Pine Needles Start Day One — Micro-Mesh Is Not Optional",
      "description": "Any new gutter installed without 50-micron pine needle protection in Bella Vista will be clogged within 60 days of installation from Loblolly and Shortleaf needle drop."
    }
  ],
  "localContext": {
