...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "On-Site Extrusion vs Pre-Cut Seamed Sections",
      "description": "The best local installers extrude seamless gutters directly on-site from a truck — no joints or seams that leak. Pre-cut sections from a hardware store always fail at connections."
    },
    {
      "title": "Laser Slope Verification Before Hanging",
      "description": "Professional gutter installation requires a digital laser level to verify 1/4\" per linear foot drainage slope — hangers placed by eye result in standing water and mosquito breeding within months."
    },
    {
      "title": "$2M Insurance & Written Guarantee",
      "description": "Never hire an uninsured ladder worker for gutter installation. If a contractor falls on your property without coverage, homeowner insurance is exposed to liability."
    }
  ],
  "localContext": {
