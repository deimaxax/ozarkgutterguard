...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Sagging Gutters Pulling from Fascia",
      "description": "Post Oak catkin weight and Ozark winter ice loads pull spike-and-ferrule hangers loose from Bentonville fascia boards, causing gutters to sag and overflow."
    },
    {
      "title": "Leaking Corner Miters & End Caps",
      "description": "Temperature cycling between Bentonville summer 105Â°F and winter sub-freezing nights cracks original silicone seals at all corner joints within 5â€“7 years."
    },
    {
      "title": "Downspout Clogs & Foundation Pooling",
      "description": "Post Oak catkins and sweetgum balls jam Bentonville downspout elbows, backing water up and pooling against clay soil foundation footings."
    }
  ],
  "localContext": {
