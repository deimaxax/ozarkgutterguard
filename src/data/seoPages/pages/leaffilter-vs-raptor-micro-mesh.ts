...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "LeafFilter ($4,500–$7,500): Best Marketing, Highest Price",
      "description": "Proven micro-mesh technology glued to uPVC plastic frame. The product works, but you're paying 3–5× the fair rate to fund TV commercials and commissioned in-home sales reps."
    },
    {
      "title": "Raptor DIY ($350–$600 materials): Best DIY Option",
      "description": "Genuine 316 stainless micro-mesh on aluminum frame — identical material specification to professional products. Requires 15+ hours on a ladder and zero slope realignment or warranty."
    },
    {
