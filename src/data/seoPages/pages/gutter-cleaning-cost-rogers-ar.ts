...
export const page: SeoPageData = {
  ...
  "painPoints": [
    {
      "title": "Standard Rogers Single-Story Cleanout: $125–$175",
      "description": "One-story homes in Historic Downtown Rogers (72756) and Prairie Creek area with standard 5-inch gutters under moderate Silver Maple canopy."
    },
    {
      "title": "Pinnacle Hills Two-Story Estate: $175–$275",
      "description": "Multi-story Pinnacle Hills and Champions Drive estates with 200+ LF, high-ladder requirements, and heavy Silver Maple seed spinner volume in April–May."
    },
    {
      "title": "Quarterly Rogers Cleaning = $2,500 Over 5 Years",
      "description": "Rogers homeowners paying $175 × 3 visits/year spend $2,625 over 5 years with zero equity, zero warranty, and gutters still vulnerable between visits."
    }
  ],
  "localContext": {
