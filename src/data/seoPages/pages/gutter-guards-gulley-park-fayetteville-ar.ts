...
export const page: SeoPageData = {
  "slug": "gutter-guards-gulley-park-fayetteville-ar",
  "cluster": "location",
  "city": "Fayetteville",
  ...
  "painPointTitle": "Gulley Park Neighborhood Drainage & Canopy Risks",
  "painPoints": [
    {
      "title": "Spring Maple Helicopters & Oak Catkins",
      "description": "Dense neighbourhood maples and oaks drop thousands of seed pods in spring that choke downspout drop outlets."
    },
    {
      "title": "Crawlspace Moisture & Mold Growth",
      "description": "Overflowing rainwater pools against foundation walls, causing damp crawlspaces and musty subfloor odours."
    },
    {
      "title": "Sagging Gutter Pitch & Mosquito Breeding",
      "description": "Standing water pockets in sagging gutters become prime breeding zones for mosquitoes near outdoor patios."
    }
  ],
  "localContext": {
