...
export const page: SeoPageData = {
  ...
  "localContext": {
    ...
    "content": "Wilson Park historic homeowners take pride in architectural preservation. Our low-profile gutter armor is mounted 100% to the gutter lip and fascia board—never slid under roof shingles, protecting original cedar shake and architectural shingles. Every installation includes hand cleaning, laser slope realignment, and miter resealing to ensure historic eaves remain rot-free for decades."
  },
  "geoCoordinates": {
    "latitude": 36.0725,
    "longitude": -94.161
