    ...
    <section className="py-14 sm:py-20 bg-white border-b border-slate-200">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="max-w-3xl space-y-2">
          <span className="text-xs font-bold text-[#D92626] uppercase tracking-wider block">Building Code &amp; Regulations</span>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-[#F8F9FA] p-6 sm:p-8 rounded-2xl border border-slate-200 space-y-4 shadow-xs">
            <div className="flex items-center gap-3 border-b border-slate-200 pb-3.5">
              <div className="w-10 h-10 bg-[#0F1E36] text-white rounded-xl flex items-center justify-center font-bold">
                <Building2 className="w-5 h-5" />
              </div>
              <div>
                <h3 className="font-bold text-[#0F1E36] text-base">Local Building Authority</h3>
            ...
            <div className="space-y-3.5 text-xs sm:text-sm text-slate-700">
              <div>
                <strong className="text-[#0F1E36] block font-semibold mb-0.5">Adopted Code Standard:</strong>
                <span className="text-slate-600 font-medium">{permitInfo.drainageCodeStandard}</span>
              </div>

              <div>
                <strong className="text-[#0F1E36] block font-semibold mb-0.5">Permit Requirements:</strong>
                <p className="text-slate-600 leading-relaxed font-normal">{permitInfo.permitRequirement}</p>
              </div>

              <div>
                <strong className="text-[#0F1E36] block font-semibold mb-0.5">Contractor Licensing:</strong>
                <p className="text-[#D92626] font-semibold">{permitInfo.contractorLicenseRequired}</p>
              </div>
            </div>
          </div>
