...
export default function ComparisonMatrix() {
  ...
  const specs: SpecRow[] = [
    ...
    {
      feature: "Installed Cost (Typical Home)",
      ozark: "Starting at $1,250 (140–180 ft) — Save 50–70% vs $5,000+ Franchise Quotes",
      franchise: "$5,000 – $8,500 (Sales commissions & franchise markups)",
      diy: "$400 – $700 (Materials only + ladder risk)",
    },
    {
      feature: "Warranty Protection",
      ozark: "Lifetime Material Warranty + 10-Year No-Clog Performance Guarantee",
