...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-950 text-slate-400 pt-12 pb-24 lg:pb-12 border-t border-slate-900 text-xs font-sans">
          ...
          <div className="lg:col-span-5 space-y-3.5">
            ...
            <div className="space-y-1.5 text-slate-300 text-xs pt-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Call Us: <a href={phoneHref} className="text-white hover:text-amber-400 font-bold">{phoneDisplay}</a></span>
              </div>
              <div className="flex items-center gap-2">
